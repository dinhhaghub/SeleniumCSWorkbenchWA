    ...
    internal class PublicReportTest : BaseTestCase
    {
        ...
        public void TC001_SinglePublicReport_Albourne_NoInput()
        {
            ...
            try
            {
                ...
                verifyPoint = "Index Name" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 1)
                    && "Projected Beta" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 2)
                    && "Projected Exposure" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 3);
                ...
                verifyPoint = "" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 1)
                    && "Autoscore" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 2)
                    && "IR" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 3)
                    && "Length In Months" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 4);
                verifyPoints.Add(summaryTC = "Verify headers in the 2nd table: '" + table + "'", verifyPoint);
                ExtReportResult(verifyPoint, summaryTC);

                table = "Manager Alpha";
                verifyPoint = "Year" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 1)
                    && "Net Return" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 2)
                    && "Gross Return" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 3)
                    && "CRBM" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 4)
                    && "Gross Total Alpha" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 5)
                    && "Gross Strategy Alpha" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 6)
                    && "Gross Manager Alpha" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 7)
                    && "Fees" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 8)
                    && "Liquidity Cost" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 9)
                    && "Net Total Alpha" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 10);
                ...
                verifyPoint = "" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 1)
                    ...
                    && "Net Manager Return" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 3)
                    && "Custom Risk Benchmark" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 4);
                verifyPoints.Add(summaryTC = "Verify headers in the 4th table: '" + table + "'", verifyPoint);
                ExtReportResult(verifyPoint, summaryTC);

                table = "Metrics Over Selected Time Frames";
                verifyPoint = "" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 1)
                    && "Net Manager Return" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 2)
                    && "Gross Manager Return" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 3)
                    && "Custom Risk Benchmark" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 4)
                    && "RF Rate" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 5)
                    && "Gross Total Alpha" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 6)
                    && "Gross Strategy Alpha" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 7)
                    && "Gross Manager Alpha" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 8)
                    && "Fees" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 9)
                    && "Liquidity Cost" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 10)
                    && "Net Alpha" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 11);
                verifyPoints.Add(summaryTC = "Verify headers in the 5th table: '" + table + "'", verifyPoint);
                ExtReportResult(verifyPoint, summaryTC);

                table = "Net Monthly Return";
                verifyPoint = "CY" == SearchFundAction.Instance.HeaderTableOfReportGetText(10, table, 1);
                ...
                ExtReportResult(verifyPoint, summaryTC);
                verifyPoint = double.Parse(SearchFundAction.Instance.DataTableOfReportGetText(10, table, "1", "10").Replace("%", "")) > 0.00
                    && double.Parse(SearchFundAction.Instance.DataTableOfReportGetText(10, table, "1", "10").Replace("%", "")) < 100.00;
                ...
                ExtReportResult(verifyPoint, summaryTC);
                verifyPoint = Convert.ToDouble(SearchFundAction.Instance.DataTableOfReportGetText(10, table, "6", "3")) > 2.01
                    && Convert.ToDouble(SearchFundAction.Instance.DataTableOfReportGetText(10, table, "6", "3")) < 3.00;
                ...
                ExtReportResult(verifyPoint, summaryTC);
                verifyPoint = Convert.ToDouble(SearchFundAction.Instance.DataTableOfReportGetText(10, table, "31", "4")) > 0.00
                    && Convert.ToDouble(SearchFundAction.Instance.DataTableOfReportGetText(10, table, "31", "4")) < 100.00;
        ...
        public void TC002_SinglePublicReport_AlbourneManual_Input()
        {
            ...
            try
            {
                ...
                ExtReportResult(verifyPoint, summaryTC);
                verifyPoint = Convert.ToDouble(SearchFundAction.Instance.DataTableOfReportGetText(10, table, "6", "4")) < 200;
                ...
                ExtReportResult(verifyPoint, summaryTC);
                verifyPoint = Convert.ToDouble(SearchFundAction.Instance.DataTableOfReportGetText(10, table, "6", "5")) < 200;
