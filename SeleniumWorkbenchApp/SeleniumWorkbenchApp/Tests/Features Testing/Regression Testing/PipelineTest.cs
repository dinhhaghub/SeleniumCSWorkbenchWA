    ...
    internal class PipelineTest : BaseTestCase
    {
        ...
        public void TC001_Pipeline_Page()
        {
            ...
            try 
            {
                ...
                verifyPoint = GeneralAction.Instance.DateInTableHeaderNameGetText(10, PipelinePage.pipelineHeadertable).Contains(datePipeline);
                ...
                verifyPoint = (title = assetNameStartsWith + getCountOnePager + ")") == GeneralAction.Instance.RowNameInAssetTableGetText(10, assetNameStartsWith); // RowValuesInAssetTableGetText(10, 1, 1);
