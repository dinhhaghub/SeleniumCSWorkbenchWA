...
namespace WorkbenchApp.UITest.BDD.Features
{
    ...
    public partial class LoginFunctionalityFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "BDD/Features", "Login Functionality", "  In order to access the system\r\n  As a valid user\r\n  I want to log in using my c" +
                "redentials and view the dashboard", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("BDD/Features/Login.feature.ndjson", 3);
        }
        ...
        public async global::System.Threading.Tasks.Task SuccessfulLoginWithValidCredentials()
        {
            ...
            else
            {
                ...
                await testRunner.GivenAsync("I open the login page", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
                await testRunner.WhenAsync("I login with credentials \"valid\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
